...
{
    public class Chris_SimpleCalculator
    {
        ...
        private IList<int> validateAndConvertToValues(string romanNumeral)
        {
        ...
        private IList<string> getInvalidCombinations()
        {
        ...
        private Dictionary<char, int> getAllowedValues()
        {
